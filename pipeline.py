...
def pipeline(dataTraining,dataTest):
	...
	step0 = FeatureUnion(n_jobs=1,
       transformer_list=[('votingclassifier', VotingClassifier(estimators=[('alg0', AdaBoostClassifier(algorithm='SAMME', base_estimator=None,
          learning_rate=1.643286, n_estimators=45, random_state=42))],
         n_jobs=1, voting='hard', weights=None)), ('functiontransformer', FunctionTransformer(accept_sparse=False,
          func=<function <lambda> at 0x7fe38288a050>, inv_kw_args=None,
